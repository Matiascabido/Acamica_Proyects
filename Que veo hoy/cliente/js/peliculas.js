...
function ControladorPeliculas() {
    ...
    this.buscarPeliculas = function(pagina, cantidad) {
            ...
            //si se recibio como parametro la cantidad de resultados a mostrar se envia ese valor, sino, se piden 52 pelic
            ...
            $.getJSON(servidor + "/peliculas?" + query,
                function(data) {
                    ...
                    self.cargarListado(data.pelicula);
