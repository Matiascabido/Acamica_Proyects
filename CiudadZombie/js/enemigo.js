...
Enemigo.prototype.atacar = function (juegador) {
  this.atacando = true
  juegador.perderVidas();
}
...
Enemigo.prototype.comenzarAtaque = function (juegador) {
   !this.atacando ? this.atacar(juegador): null;
    this.atacando = true;
}
